...
const Banner = () => {
    return (
        <div className=" carousel w-full my-10 h-[550px]">
        <div id="slide1" className="carousel-item relative w-full">
          <img src="https://i.ibb.co/pdh33qT/pexels-curiosophotography-288100.jpg" className="w-full rounded-xl" />
...
" className="w-full rounded-xl"/>
        ...
        <div id="slide5" className="carousel-item relative w-full">
          <img src="
https://i.ibb.co/bzYpS6G/pexels-maria-argiroudaki-838140423-19780613.jpg" className="w-full rounded-xl"/>
          <div className="absolute flex  transform justify-end -translate-y-1/2 left-5 right-5 bottom-0">
...
" className="w-full rounded-xl"/>
        ...
        <div id="slide7" className="carousel-item relative w-full">
          <img src="https://i.ibb.co/yqfrGrP/pexels-philippe-serrand-337910945-19789717.jpg" className="w-full rounded-xl"/>
          <div className="absolute flex  transform justify-end -translate-y-1/2 left-5 right-5 bottom-0">
